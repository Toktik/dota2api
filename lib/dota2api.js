...
Dota2Api.prototype.getMatchHistoryBySequenceNum = function(start, cb) {
	var config = {
		start_at_match_seq_num: start
	};

  this.request('IDOTA2Match_570', 'GetMatchHistoryBySequenceNum', config, cb);
}
...
Dota2Api.prototype.GetLeagues = function ( cb ) {
	var config = {
    language: 'en'
  };
  this.request('IDOTA2Match_570', 'GetLeagueListing', config, cb);
}

Dota2Api.prototype.GetLiveLeagueGames = function ( cb ) {
  this.request('IDOTA2Match_570', 'GetLiveLeagueGames', {}, cb);
}
